...
interface EditTaskModalProps {
  ...
  onClose: () => void;
  task: Task | null;
  onUpdate: (taskId: string, taskData: UpdateTaskData) => void;
}
        ...
        >
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold text-[hsl(0,0%,98.5%)]">Edit Task</h2>
              <Button
                variant="ghost"
                size="sm"
                onClick={handleClose}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked:boolean) => setFormData(prev => ({ ...prev, isImportant: Boolean(checked) }))}
                />
